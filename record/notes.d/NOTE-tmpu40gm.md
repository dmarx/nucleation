...
<!-- inactive-ok-file: LIT-tmpsefzj — Deferred: this is the seeded skim of the paper, filed with it on 2026-09-26; the directive lapses when its status changes -->

# NOTE-tmpu40gm: Watson — On the philosophy of unsupervised learning
...
- Directly relevant to how the anthology frames representation learning and clustering as discovery tools. It pairs naturally with [LIT-tmpkd689](../literature.d/LIT-tmpkd689.md) (Søgaard), which disputes the claim that unsupervised clustering is epistemically privileged.
