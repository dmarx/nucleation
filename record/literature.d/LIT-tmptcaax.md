...
implementations: []
summary: >-
  Hoffman et al. (2011), [ARXIV-1111.4246](https://arxiv.org/abs/1111.4246). NUTS removes HMC's trajectory-length parameter L by building trajectories recursively (doubling) until they begin to turn back on themselves. With step size tuned automatically by Nesterov-style dual averaging, it matches or beats well-tuned HMC with no hand tuning.
---

# LIT-tmptcaax: The No-U-Turn Sampler: Adaptively Setting Path Lengths in Hamiltonian Monte Carlo
...
Filed from the survey of 2026-09-25 of work the anthology set aside as out of scope (tier C): 370 seconds of active reading over 3 sessions in the papers-feed tracker. `Deferred` because nobody has read it closely here yet, not on merit.
