...
number: 64
status: Superseded
superseded_by: ANTH-LIT-726
formerly:
- LIT-tmpgblor
status_note: 'moved to the Anthology of the SOTA as ANTH-LIT-726 on 2026-09-26, at the owner''s request, with its Read NOTE; nothing is held in both records (ADR-001)'
...
- version: 3
  date: '2026-09-25'
  note: >-
    Superseded by ANTH-LIT-726: the owner filed this paper in the anthology,
    where its reading flagged it as a possible boundary work (exact
    Gaussian-score relations for softmax sharpness). The body stays as the
    record of where it was first read.
tags:
- mathematics
