...
<!-- inactive-ok-file: LIT-212 — Deferred: this is the seeded skim of the paper, filed with it on 2026-09-26; the directive lapses when its status changes -->
...
- The conceptual point, that sentience self-reports are by construction candidates for hallucination, overlaps with Birch's [LIT-111](../literature.d/LIT-111.md) "gaming problem" and Seth's [LIT-135](../literature.d/LIT-135.md) conscious-seeming AI. It may belong in a cluster note, not a note of its own.
