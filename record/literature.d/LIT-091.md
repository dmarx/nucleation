...
implementations: []
summary: >-
  Battiston et al. (2020), [ARXIV-2006.01764](https://arxiv.org/abs/2006.01764). Many systems' interactions happen in groups rather than pairs. Representing them explicitly, as hypergraphs or simplicial complexes, changes both the measured structure and the dynamics, and in particular adds new non-linearities and abrupt (explosive) transitions that pairwise models miss.
---
