...
<!-- inactive-ok-file: LIT-tmpp1uor — Deferred: this is the seeded skim of the paper, filed with it on 2026-09-26; the directive lapses when its status changes -->

# NOTE-tmptz3my: Algorithmic nudging needs interdisciplinary oversight
