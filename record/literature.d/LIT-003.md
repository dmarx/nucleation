...
implementations: []
summary: >-
  Schmid et al. (2020), [ARXIV-2005.07161](https://arxiv.org/abs/2005.07161). In any diagram-preserving generalized-noncontextual ontological model of a tomographically local operational theory, the model must be an exact (non-overcomplete) frame representation of the associated GPT, so the number of ontic states equals the GPT dimension (for example exactly d² for a qudit).
---
...
Filed by the reading-time triage of 2026-09-25: 660 seconds of active reading over 2 sessions in the papers-feed tracker. `Deferred` because nobody has read it closely here yet, not on merit.
