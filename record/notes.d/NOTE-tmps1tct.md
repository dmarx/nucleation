...
<!-- inactive-ok-file: LIT-tmpfci9j — Deferred: this is the seeded skim of the paper, filed with it on 2026-09-26; the directive lapses when its status changes -->

# NOTE-tmps1tct: Martínez — information-processing view of representation
