...
---
<!-- inactive-ok-file: LIT-tmpkd689 — Deferred: a seed from the same 2026-09-26 philosophy sweep, cross-referenced by the citing work's dossier; lapses when the cited work is read -->

# LIT-tmpsefzj: On the Philosophy of Unsupervised Learning
...
**Priority for a deeper reading: medium — only 5 s dwell, but it is the standard philosophical reference on unsupervised learning, and [LIT-tmpkd689](LIT-tmpkd689.md) responds to this line of argument.**

What a deeper reading should check:

- Directly relevant to how the anthology frames representation learning and clustering as discovery tools. It pairs naturally with [LIT-tmpkd689](LIT-tmpkd689.md) (Søgaard), which disputes the claim that unsupervised clustering is epistemically privileged.
